...
include $(SINGLE_LINKED_LIST_ROOT_DIR)/Makefile.variable
...
OBJ_CIRCULAR_SINGLE_LINKED_LIST = $(patsubst %,$(ODIR)/$(ODIR_SLL)/$(ODIR_CLL)/%,$(_OBJ_CIRCULAR_SINGLE_LINKED_LIST))

_OBJ_MAIN_CIRCULAR_SINGLE_LINKED_LIST = csll_test.o
OBJ_MAIN_CIRCULAR_SINGLE_LINKED_LIST = $(patsubst %,$(ODIR)/$(ODIR_SLL)/$(ODIR_CLL)/%,$(_OBJ_MAIN_CIRCULAR_SINGLE_LINKED_LIST))

_LIB_NAME = lib$(LIB_NAME).a
GEN_LIB_CIRCULAR_SINGLE_LINKED_LIST = $(patsubst %,$(LIB_DIR)/%,$(_LIB_NAME))


$(ODIR)/$(ODIR_SLL)/$(ODIR_CLL)/%.o: %.c $(DEPS_CIRCULAR_SINGLE_LINKED_LIST)
		@mkdir -p $(@D)
		$(CC) -g -c -o $@ $< $(CFLAGS)
