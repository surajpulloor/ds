...
$(ODIR)/%.o: %.c $(DEPS_SINGLE_LINKED_LIST)
		@mkdir -p $(@D)
		$(CC) -g -c -o $@ $< $(CFLAGS)
...
$(LIB_DIR)/%.a: $(OBJ_SINGLE_LINKED_LIST) $(OBJ_SINGLE_LINKED_LIST_COPY_TO_BUFFER) $(OBJ_SINGLE_LINKED_LIST_COPY_TO_NODE) $(OBJ_SINGLE_LINKED_LIST_INIT) $(OBJ_SINGLE_LINKED_LIST_PRINT_NODE_VALUE) $(OBJ_SINGLE_LINKED_LIST_SETUP_BUFFER_LENGTH)
		@mkdir -p $(LIB_DIR)
		ar -rc $@ $^
